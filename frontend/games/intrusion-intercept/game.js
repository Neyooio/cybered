...
const securityTopics = {
    "Phishing & Social Engineering": [
        { id: 0, title: "Suspicious Email", description: "Urgent email from 'IT' requests credentials", choices: [
            ...
            { text: "Contact IT department directly", correct: true, impact: 10, feedback: "Excellent! You identified phishing and verified properly.", nextScenario: 2 },
        ...
        { id: 1, description: "Credentials stolen! Attacker accessing data", choices: [
            { text: "Disconnect from network immediately", correct: true, impact: 15, feedback: "Smart! Isolation limits the breach.", nextScenario: 3 },
        ...
        { id: 2, description: "Email verified as legitimate", choices: [
            { text: "Follow instructions safely", correct: true, impact: 5, feedback: "Good! Verification prevented a mistake.", nextScenario: 3 },
        ...
        { id: 3, description: "Found USB drive in parking lot", choices: [
            { text: "Plug it in to check contents", correct: false, impact: -25, feedback: "Dangerous! USB contained ransomware.", nextScenario: 4 },
            { text: "Turn it to IT/security", correct: true, impact: 10, feedback: "Perfect! IT confirms it contained malware.", nextScenario: 5 },
            { text: "Throw it away", correct: false, impact: -5, feedback: "Better report it. Someone else might use it.", nextScenario: 4 }
        ]},
        { id: 4, description: "Malware spreading through network", choices: [
            { text: "Isolate affected systems", correct: true, impact: 15, feedback: "Quick action prevents wider infection.", nextScenario: 6 },
        ...
        { id: 5, description: "USB returned safely to owner", choices: [
            { text: "Document the incident", correct: true, impact: 5, feedback: "Good practice for security tracking.", nextScenario: 6 },
        ...
        { id: 6, description: "Working from coffee shop", choices: [
            { text: "Use open public WiFi", correct: false, impact: -20, feedback: "Bad choice! Credentials were intercepted.", nextScenario: 7 },
            { text: "Use company VPN", correct: true, impact: 10, feedback: "Excellent! Secure connection protects data.", nextScenario: 8 },
            { text: "Use phone hotspot", correct: false, impact: 5, feedback: "Safer than public WiFi but VPN is best.", nextScenario: 8 }
        ]},
        { id: 7, description: "Login credentials compromised", choices: [
            { text: "Change all passwords immediately", correct: true, impact: 10, feedback: "Quick response limits damage.", nextScenario: 9 },
        ...
        { id: 8, description: "Security team investigating breach", choices: [
            { text: "Provide detailed report", correct: true, impact: 10, feedback: "Great teamwork helps investigation.", nextScenario: 9 },
        ...
        { id: 9, description: "Final security awareness training", choices: [
            { text: "Complete all modules", correct: true, impact: 15, feedback: "Excellent commitment to security!", nextScenario: null },
    ...
    "Ransomware Defense": [
        { id: 0, title: "Files Encrypting", description: "Screen shows ransomware message demanding payment", choices: [
            ...
            { text: "Restore from backup", correct: true, impact: 15, feedback: "Correct! Backups are the best defense.", nextScenario: 2 },
            { text: "Try to decrypt files", correct: false, impact: -10, feedback: "Without proper tools, this wastes time.", nextScenario: 1 }
        ]},
        { id: 1, description: "Ransomware paid but files still locked", choices: [
            { text: "Contact law enforcement", correct: true, impact: 5, feedback: "Good. Report cyber crimes.", nextScenario: 3 },
        ...
        { id: 2, description: "Files successfully restored", choices: [
            { text: "Analyze how ransomware entered", correct: true, impact: 10, feedback: "Critical to prevent future attacks.", nextScenario: 3 },
        ...
        { id: 3, description: "Suspicious email attachment", choices: [
            { text: "Open to see what it is", correct: false, impact: -25, feedback: "Infected! Ransomware spreading.", nextScenario: 4 },
            { text: "Report to IT security", correct: true, impact: 10, feedback: "Perfect protocol! Threat neutralized.", nextScenario: 5 },
            { text: "Delete without reporting", correct: false, impact: -5, feedback: "Report threats to protect everyone.", nextScenario: 5 }
        ]},
        { id: 4, description: "System locked, ransomware active", choices: [
            { text: "Immediately disconnect network", correct: true, impact: 15, feedback: "Quick thinking! Contained the spread.", nextScenario: 6 },
        ...
        { id: 5, description: "IT investigating the threat", choices: [
            { text: "Cooperate fully", correct: true, impact: 5, feedback: "Teamwork strengthens security.", nextScenario: 6 },
        ...
        { id: 6, description: "Backup system verification needed", choices: [
            { text: "Test backup restoration", correct: true, impact: 10, feedback: "Smart! Verified backups work.", nextScenario: 7 },
        ...
        { id: 7, description: "New backup strategy proposed", choices: [
            { text: "Implement 3-2-1 backup rule", correct: true, impact: 10, feedback: "Excellent! Industry best practice.", nextScenario: 8 },
        ...
        { id: 8, description: "Employee training on ransomware", choices: [
            { text: "Attend all sessions", correct: true, impact: 10, feedback: "Knowledge is your best defense.", nextScenario: 9 },
        ...
        { id: 9, description: "Final security audit", choices: [
            { text: "Participate fully and implement findings", correct: true, impact: 15, feedback: "Outstanding commitment to security!", nextScenario: null },
    ...
    "Password Security": [
        { id: 0, title: "Password Policy", description: "Company implements new password requirements", choices: [
            ...
            { text: "Use password manager", correct: true, impact: 15, feedback: "Excellent! Best practice for password security.", nextScenario: 2 },
            { text: "Write passwords down", correct: false, impact: -15, feedback: "Physical security risk! Use password manager.", nextScenario: 1 }
        ]},
        { id: 1, description: "Account compromised due to weak password", choices: [
            { text: "Change all related passwords", correct: true, impact: 10, feedback: "Good response! Limit the damage.", nextScenario: 3 },
        ...
        { id: 2, description: "Password manager set up successfully", choices: [
            { text: "Generate strong unique passwords", correct: true, impact: 10, feedback: "Perfect! Maximum security.", nextScenario: 3 },
        ...
        { id: 3, description: "Multi-factor authentication offered", choices: [
            { text: "Enable on all accounts", correct: true, impact: 15, feedback: "Excellent! Major security boost.", nextScenario: 4 },
        ...
        { id: 4, description: "SMS verification code received unexpectedly", choices: [
            { text: "Ignore and change password immediately", correct: true, impact: 10, feedback: "Smart! Someone tried to access your account.", nextScenario: 5 },
        ...
        { id: 5, description: "Account secured after suspicious activity", choices: [
            { text: "Review recent login history", correct: true, impact: 5, feedback: "Good practice! Monitor for anomalies.", nextScenario: 7 },
        ...
        { id: 6, description: "Phishing link clicked, credentials entered", choices: [
            { text: "Contact security team immediately", correct: true, impact: 10, feedback: "Quick action can limit damage.", nextScenario: 7 },
        ...
        { id: 7, description: "Biometric authentication available", choices: [
            { text: "Enable as additional factor", correct: true, impact: 10, feedback: "Great! Adds strong security layer.", nextScenario: 8 },
        ...
        { id: 8, description: "Password sharing request from colleague", choices: [
            { text: "Refuse and explain policy", correct: true, impact: 10, feedback: "Correct! Never share credentials.", nextScenario: 9 },
        ...
        { id: 9, description: "Annual password security review", choices: [
            { text: "Update all security measures", correct: true, impact: 15, feedback: "Excellent! Stay current with best practices.", nextScenario: null },
    ...
    "Network Security": [
        { id: 0, title: "Unknown Device", description: "Alert shows unknown device on network", choices: [
            { text: "Investigate immediately", correct: true, impact: 15, feedback: "Correct! Could be an attacker.", nextScenario: 2 },
        ...
        { id: 1, description: "Attacker gained network access", choices: [
            { text: "Shut down network", correct: true, impact: 15, feedback: "Isolation prevents further damage!", nextScenario: 3 },
        ...
        { id: 2, description: "Device was employee's personal phone", choices: [
            { text: "Enforce BYOD policy", correct: true, impact: 10, feedback: "Policies prevent security gaps!", nextScenario: 3 },
        ...
        { id: 3, description: "Firewall update available", choices: [
            { text: "Review and apply updates", correct: true, impact: 10, feedback: "Updated firewalls block new threats!", nextScenario: 4 },
        ...
        { id: 4, description: "VPN disconnected during remote work", choices: [
            { text: "Stop work until reconnected", correct: true, impact: 10, feedback: "VPN ensures secure communication!", nextScenario: 5 },
        ...
        { id: 5, description: "Port scan detected on network", choices: [
            { text: "Block source and alert security", correct: true, impact: 15, feedback: "Port scans indicate reconnaissance!", nextScenario: 6 },
        ...
        { id: 6, description: "Guest WiFi needs configuration", choices: [
            { text: "Segregate from main network", correct: true, impact: 10, feedback: "Network segmentation is critical!", nextScenario: 7 },
        ...
        { id: 7, description: "IDS alerts on unusual traffic", choices: [
            { text: "Investigate immediately", correct: true, impact: 10, feedback: "IDS alerts require prompt attention!", nextScenario: 8 },
        ...
        { id: 8, description: "Network performance degraded", choices: [
            { text: "Check for DDoS attack", correct: true, impact: 10, feedback: "Performance issues can indicate attacks!", nextScenario: 9 },
        ...
        { id: 9, description: "Network security audit scheduled", choices: [
            { text: "Participate and implement findings", correct: true, impact: 15, feedback: "Audits strengthen security posture!", nextScenario: null },
    ...
    "Data Protection": [
        { id: 0, title: "Sensitive File Sharing", description: "Need to share confidential document", choices: [
            { text: "Email without encryption", correct: false, impact: -25, feedback: "Sensitive data must be encrypted!", nextScenario: 1 },
            { text: "Use encrypted file sharing", correct: true, impact: 10, feedback: "Encryption protects data in transit!", nextScenario: 2 },
        ...
        { id: 1, description: "Data breach! Unencrypted files exposed", choices: [
            { text: "Notify affected parties immediately", correct: true, impact: 15, feedback: "Transparency and quick action are crucial!", nextScenario: 3 },
        ...
        { id: 2, description: "File shared securely", choices: [
            { text: "Set expiration date", correct: true, impact: 5, feedback: "Good! Limits exposure window.", nextScenario: 3 },
        ...
        { id: 3, description: "Old documents in file server", choices: [
            { text: "Archive with retention policy", correct: true, impact: 10, feedback: "Proper data lifecycle management!", nextScenario: 4 },
        ...
        { id: 4, description: "Customer requests data deletion", choices: [
            { text: "Delete as requested", correct: true, impact: 10, feedback: "Privacy rights must be honored!", nextScenario: 5 },
        ...
        { id: 5, description: "Database backup location", choices: [
            { text: "Encrypted off-site storage", correct: true, impact: 15, feedback: "Off-site encrypted backups ensure recovery!", nextScenario: 6 },
        ...
        { id: 6, description: "Laptop with customer data lost", choices: [
            { text: "Report and remotely wipe", correct: true, impact: 10, feedback: "Quick action minimizes exposure!", nextScenario: 7 },
        ...
        { id: 7, description: "Data classification needed", choices: [
            { text: "Implement classification system", correct: true, impact: 10, feedback: "Classification guides protection!", nextScenario: 8 },
        ...
        { id: 8, description: "Vendor requests data access", choices: [
            { text: "Review contract and limit access", correct: true, impact: 10, feedback: "Vendor access must be controlled!", nextScenario: 9 },
        ...
        { id: 9, description: "Data protection audit", choices: [
            { text: "Complete audit and implement all findings", correct: true, impact: 15, feedback: "Outstanding data protection!", nextScenario: null },
    ...
    "Mobile Security": [
        { id: 0, title: "App Permissions", description: "New app requests access to contacts and location", choices: [
            { text: "Grant all permissions", correct: false, impact: -20, feedback: "Only grant necessary permissions!", nextScenario: 1 },
            { text: "Review and grant only necessary", correct: true, impact: 10, feedback: "Perfect! Minimize app access.", nextScenario: 2 },
            { text: "Deny all and don't install", correct: false, impact: -5, feedback: "Some permissions may be legitimate.", nextScenario: 2 }
        ]},
        { id: 1, description: "App harvesting contact data", choices: [
            { text: "Uninstall immediately and report", correct: true, impact: 10, feedback: "Quick action limits data exposure!", nextScenario: 3 },
        ...
        { id: 2, description: "App installed successfully", choices: [
            { text: "Monitor behavior regularly", correct: true, impact: 5, feedback: "Good practice! Stay vigilant.", nextScenario: 3 },
        ...
        { id: 3, description: "Device update available", choices: [
            { text: "Install immediately", correct: true, impact: 10, feedback: "Updates patch security vulnerabilities!", nextScenario: 4 },
        ...
        { id: 4, description: "Phone left in taxi", choices: [
            { text: "Remote wipe immediately", correct: true, impact: 15, feedback: "Protect your data first!", nextScenario: 5 },
        ...
        { id: 5, description: "Device recovered", choices: [
            { text: "Factory reset before use", correct: true, impact: 10, feedback: "Smart! Could have been tampered with.", nextScenario: 6 },
        ...
        { id: 6, description: "Public charging station available", choices: [
            { text: "Use own power bank", correct: true, impact: 10, feedback: "Avoids juice jacking risk!", nextScenario: 7 },
        ...
        { id: 7, description: "MDM enrollment required", choices: [
            { text: "Enroll company device", correct: true, impact: 10, feedback: "MDM ensures security compliance!", nextScenario: 8 },
        ...
        { id: 8, description: "Screen lock not set", choices: [
            { text: "Enable strong biometric + PIN", correct: true, impact: 10, feedback: "Excellent! Multi-layer protection.", nextScenario: 9 },
        ...
        { id: 9, description: "Mobile security audit", choices: [
            { text: "Implement all recommendations", correct: true, impact: 15, feedback: "Excellent mobile security!", nextScenario: null },
...
function updateHUD() {
    ...
    // Show scenario title in HUD
    const currentScenario = gameState.currentScenarios[gameState.currentScenario];
    const scenarioTitle = currentScenario && currentScenario.title ? currentScenario.title : gameState.currentTopic;
    document.getElementById('scenario').textContent = scenarioTitle;
...
function displayScenarioChoices(scenario) {
    ...
    scenarioTitle.textContent = scenario.title || gameState.currentTopic;
...
function endGame() {
    ...
    if (gameState.score >= 90) {
        ...
        gameOverTitle.textContent = 'Security Professional';
        ...
        gameOverTitle.textContent = 'Security Risk';
